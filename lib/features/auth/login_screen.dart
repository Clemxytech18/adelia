...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate heights based on screen size ratio to match design
                    ...
                    Positioned(
                      ...
                      child: Align(
                        ...
                        child: Image.asset(
                          ...
                          fit: BoxFit
                              .contain, // or BoxFit.none if strictly original size is needed, but 'contain' is safer for general 'original aspect ratio' look
                        ),
                      ),
                    ),
                              ...
                              child: RichText(
                                text: const TextSpan(
                                  style: TextStyle(
                                    ...
                                    color: Colors.white,
                                    fontFamily:
                                        'Poppins', // Ensure font covers spacing
                                  ),
                                  children: [
                                    TextSpan(text: 'Log '),
                                    TextSpan(
